...
const planPath = path.join(root, 'reports', 'sprint-1-normalizacion', 'sprint1_2_metadata_plan.json');
...
console.log(`Metadatos Sprint 1.2 aplicados a ${plan.length} productos.`);
