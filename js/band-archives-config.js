(function initBandArchivesConfig(root, factory) {
    ...
    return Object.freeze([
        ...
        },
        {
            ...
            heroDisplayName: 'HELLOWEEN · SHOW 13/9 · ÚLTIMA SEMANA',
            ...
            heroTitle: 'COLECCIÓN HELLOWEEN 40 YEARS',
            heroCopy: '<strong>+50 diseños disponibles</strong><br>Remeras desde $37.000<br>Si la querés para el show, consultanos antes de comprar para confirmar la mejor opción de entrega según tu zona.',
            heroCtaLabel: 'VER LOS +50 DISEÑOS',
            heroQualityLine: 'DTG PREMIUM · ALGODÓN PEINADO · SIN TACTO PLÁSTICO',
            hideShippingPromo: true,
            productionTitle: 'PRODUCCIÓN 48–72 H HÁBILES',
            productionCopy: 'Para pedidos destinados al show del 13/9, consultanos antes de comprar. La opción de entrega depende de la localidad.',
            productionCta: {
                label: 'CONSULTAR ENTREGA',
                href: 'https://wa.me/541169667685?text=Hola%20FMD!%20Quiero%20consultar%20la%20opci%C3%B3n%20de%20entrega%20para%20tener%20una%20prenda%20de%20Helloween%20antes%20del%20show%20del%2013%2F9.%20Mi%20localidad%20es%3A%20'
            },
            ...
            showSizeGuide: true,
            showcase: {
                campaignPreview: 'helloween-show-2026',
            ...
            collections: [
                ...
                { id: 'era-1990-1999', label: '1990-1999', match: { designIds: [
                    'helloween-master',
                    'helloween-the-time-of-the-oath',
                    'helloween-the-time',
                    'helloween-better-than-raw',
                ...
                { id: 'era-2000-2009', label: '2000-2009', match: { designIds: [
                    'helloween-the-dark-ride',
                    'helloween-the-legacy',
                    'helloween-gambling-with-the-devil'
                ] } },
                { id: 'era-2010-2019', label: '2010-2019', match: { designIds: [
                    'helloween-7-sinners',
                    'helloween-straight-out-of-hell',
                    'helloween-pumpkins-united',
                    'helloween-pumpkins-united-ii',
