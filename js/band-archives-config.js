(function initBandArchivesConfig(root, factory) {
    ...
    return Object.freeze([
        ...
        },
        {
            ...
            heroCopy: '<strong>Más de 40 diseños disponibles</strong><br>Remeras desde $37.000 · Envío gratis a punto Andreani desde 1 prenda hasta el 3/9<br><strong>Pedila con tiempo para el show del 13/9</strong>',
            heroCtaLabel: 'VER LAS +40 REMERAS',
            heroQualityLine: 'DTG PREMIUM · ALGODÓN PEINADO · SIN TACTO PLÁSTICO',
            promoKicker: 'BENEFICIO HELLOWEEN · HASTA EL 3/9',
            promoTitle: 'ENVÍO GRATIS <em>A PUNTO ANDREANI</em>',
            promoPrimary: 'DESDE 1 PRENDA',
            promoSecondary: '3 PRENDAS O MÁS · 10% OFF + ENVÍO GRATIS A DOMICILIO',
            ...
            showcase: {
                ...
                title: 'MÁS DE 40 REMERAS HELLOWEEN',
                copy: 'Tocá un diseño para verlo en detalle.',
                ctaLabel: 'VER LAS +40 REMERAS',
                durationSeconds: 60,
                order: [
